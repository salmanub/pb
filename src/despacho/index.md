...
claustro_block:
  ...
  p: "Cuando la materia controvertida excede la competencia acreditada de la dirección pericial —el modelo de cálculo, la caracterización de un material, la interacción suelo-estructura, la práctica constructiva efectivamente ejecutada—, el dictamen incorpora a un perito especializado en esa materia, cuya autoría consta en el informe, mientras la dirección pericial mantiene la interlocución y la responsabilidad procesal. El aval de ese perito procede de la universidad, de la docencia compatibilizada con ejercicio propio, de la dirección de obra, de una especialidad instrumental, de la industria ya desvinculada o de las listas de otros colegios: seis procedencias, ninguna subsidiaria de las demás. Las seis materias constan en el <a href='/cuadro-de-expertos/'>cuadro de expertos</a>, y las condiciones de alta, en <a href='/colaboracion-peritos/'>colaboración de peritos</a>."
qualLabel: "Habilitación profesional"
qualItems:
  - { num: "TÍT", text: "Ingeniero Civil — ETSECCPB · UPC" }
  - { num: "COL", text: "ECCAT nº 16448" }
  - { num: "JUD", text: "Perito Judicial — Ministerio de Justicia" }
  - { num: "IRD", text: "Perito de Seguros — INESE" }
  - { num: "BCN", text: "C. de Numància, 95 · 08029 Barcelona" }
  - { num: "GRA", text: "C. Navarra, 14 · 08401 Granollers" }
qualCta: "Consultar disponibilidad"
qualNote: "L–J 9h–18h · V 9h–14h · Cita previa"

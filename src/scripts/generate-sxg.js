...
async function main() {
    ...
    // Disabled cert.cbor generation due to tool incompatibility. Assuming cert.cbor is generated by previous step.
    console.log('⚠️ Skipping cert.cbor generation inside script.');

...
firm_description:
  ...
  - "Nuestra firma se rige por la máxima imparcialidad y rigor normativo. Analizamos cada asunto basándonos exclusivamente en cálculos de ingeniería, el Código Técnico de la Edificación (CTE) y evidencias físicas extraídas mediante ensayos, garantizando un dictamen inexpugnable ante los Tribunales."
team_section:
...
team_members:
  ...
  - name: "Joan Franch"
    ...
    role: "Geólogo y Soporte Técnico Geotécnico"
    license_label: "Col. Nº"
    license: "4169"
    description:
      - "Geólogo colegiado con más de 20 años de experiencia, aportando el soporte científico fundamental en mecánica de suelos e interacción terreno-estructura."

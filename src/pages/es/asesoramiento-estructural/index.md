...
sections:
  ...
  what_is:
    text: >
      Contratar a un consultor estructural independiente antes que a una empresa constructora garantiza que la solución propuesta responda a una necesidad técnica real y no a un interés comercial. Este paso previo es la mejor inversión para su proyecto.
    features:
      - "Garantiza la elección de la solución técnica más eficiente, no la más cara"
      - "Proporciona un control de costes real al definir previamente las actuaciones"
      - "Evita reparaciones innecesarias o sobredimensionadas"
      - "Permite solicitar presupuestos a constructoras sobre una base técnica clara"
      - "Actúa como una supervisión experta que defiende sus intereses"
      - "Asegura el cumplimiento de la normativa específica (EHE-08, CTE, etc.)"

# Service Cluster: Ahora incluye servicios de Edificación Y Obra Civil
serviceCluster:
  title: "Nuestros Servicios de Consultoría Estructural"
  ...
  services:
    ...
    - title: "Refuerzo y Recalce de Cimentaciones"
      description: "Estudio de asientos diferenciales y problemas en el terreno para proyectar soluciones como micropilotes, inyecciones o ampliación de zapatas."
      url: "/asesoramiento-estructural/refuerzo-cimentaciones/"
      icon: "anchor"
      features:
        - "Análisis de asientos"
        - "Soluciones con micropilotes"
    ...
    - title: "Proyectos de Reparación de Hormigón"
      ...
      features:
        ...
        - "Especificación de morteros"
        - "Sistemas de protección"

# Puente hacia Urbenis.com
urbenisBridge:
  title: "Del Diagnóstico a la Ejecución: Colaboración con Urbenis"
  text: >
    Nuestra labor en **perito.barcelona** es ofrecerle el diagnóstico imparcial y el mejor proyecto técnico para su tranquilidad y seguridad.
    Para una **ejecución especializada** con las máximas garantías, colaboramos estrechamente con **urbenis.com**, expertos en la aplicación de sistemas avanzados de refuerzo y reparación estructural.
  cta:
    text: "Conocer Servicios de Ejecución de Urbenis"
    url: "https://urbenis.com"
    icon: "arrow-right"

# Proceso de Trabajo
process:
  title: "Nuestra Metodología de Asesoramiento"
  steps:
    - title: "Toma de Contacto y Análisis Previo"
      description: "Estudiamos su problema y la documentación existente para entender la situación."
    - title: "Inspección Técnica y Diagnóstico"
      description: "Visitamos la estructura para inspeccionar los daños y tomar los datos necesarios."
    - title: "Propuesta Técnica de Solución"
      description: "Elaboramos un informe o proyecto con el diagnóstico y la solución de reparación o refuerzo más adecuada."
...
testimonials:
  ...
  items:
    - quote: "Su asesoramiento independiente nos ahorró mucho dinero. Otra empresa nos había propuesto una solución mucho más cara e invasiva que no era necesaria."
      author: "Administrador de Fincas, Barcelona"
      role: "Caso: Refuerzo de forjado en edificio residencial"
    - quote: "El proyecto de refuerzo con fibra de carbono para el paso inferior fue impecable. Muy detallado y claro, nos dio la seguridad técnica que necesitábamos ante la Administración."
      author: "Jefe de Obra, Constructora de Infraestructuras"
      role: "Caso: Refuerzo de viga en obra civil"

# CTA final
cta:
  title: "¿Tiene dudas sobre la seguridad de una estructura?"
  description: "No espere a que el problema se agrave. Contacte con nuestro equipo y obtenga un diagnóstico técnico profesional, ya sea para edificación u obra civil."
  button:

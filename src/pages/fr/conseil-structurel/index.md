...
sections:
  ...
  what_is:
    text: >
      Engager un consultant en structure indépendant avant une entreprise de construction garantit que la solution proposée répond à un besoin technique réel et non à un intérêt commercial. Cette étape préalable est le meilleur investissement pour votre projet.
    features:
      - "Garantit le choix de la solution technique la plus efficace, pas la plus chère"
      - "Fournit un contrôle des coûts réel en définissant au préalable les interventions"
      - "Évite les réparations inutiles ou surdimensionnées"
      - "Permet de demander des devis aux constructeurs sur une base technique claire"
...
serviceCluster:
  ...
  services:
    - title: "Diagnostic de Pathologies (Béton, Acier)"
      description: "Analyse de la fissuration, corrosion des armatures, déformations, fatigue et autres dommages pour déterminer leur cause, leur portée et leur niveau de risque."
      url: "/fr/conseil-structurel/diagnostic-pathologies/"
      icon: "search-check"
      features:
    ...
    - title: "Inspection et Pathologie des Ponts et Passerelles"
      ...
      features:
        ...
        - "Pathologie des tabliers et piles"
        - "Plans de maintenance"
    - title: "Projets de Renforcement en Fibre de Carbone"
      description: "Conception et calcul de renforts en composites (CFRP) pour poutres, poteaux, planchers et structures de génie civil nécessitant une augmentation de capacité."
      url: "/fr/conseil-structurel/renforcement-fibre-carbone/"
      icon: "tool"
      features:
    ...
    - title: "Analyse de Murs de Soutènement et Talus"
      ...
      features:
        ...
        - "Solutions d'ancrage"
    - title: "Renforcement et Reprise en Sous-œuvre de Fondations"
      description: "Étude des tassements différentiels et des problèmes de sol pour concevoir des solutions comme les micropieux, les injections ou l'élargissement de semelles."
      url: "/fr/conseil-structurel/renforcement-fondations/"
      icon: "anchor"
      features:
        - "Analyse des tassements"
        - "Solutions avec micropieux"
        - "Stabilisation du sol"
    - title: "Projets de Réparation du Béton"
      description: "Nous définissons des protocoles techniques pour la réparation correcte du béton endommagé selon la réglementation, tant dans le bâtiment que dans le génie civil."
      url: "/fr/conseil-structurel/reparation-beton/"
      icon: "construction"
      features:
        - "Protocoles de purge"
...
process:
  ...
  steps:
    - title: "Prise de Contact et Analyse Préalable"
      description: "Nous étudions votre problème et la documentation existante pour comprendre la situation."
    - title: "Inspection Technique et Diagnostic"
      description: "Nous visitons la structure pour inspecter les dommages et collecter les données nécessaires."
    - title: "Proposition Technique de Solution"
      description: "Nous élaborons un rapport ou un projet avec le diagnostic et la solution de réparation ou de renforcement la plus appropriée."
...
testimonials:
  ...
  items:
    - quote: "Leur conseil indépendant nous a fait économiser beaucoup d'argent. Une autre entreprise nous avait proposé une solution beaucoup plus chère et invasive qui n'était pas nécessaire."
      author: "Gestionnaire d'Immeubles, Barcelone"
      role: "Cas : Renforcement de plancher dans un immeuble résidentiel"
    - quote: "Le projet de renforcement en fibre de carbone pour le passage inférieur était impeccable. Très détaillé et clair, il nous a donné la sécurité technique dont nous avions besoin face à l'Administration."
      author: "Chef de Chantier, Constructeur d'Infrastructures"
      role: "Cas : Renforcement de poutre en génie civil"

# CTA final
cta:
  title: "Vous avez des doutes sur la sécurité d'une structure ?"
  description: "N'attendez pas que le problème s'aggrave. Contactez notre équipe et obtenez un diagnostic technique professionnel, que ce soit pour le bâtiment ou le génie civil."
  button:
    text: "Demander un Diagnostic Structurel"
    url: "/fr/contact/"
---

## La Décision la Plus Importante : Un Diagnostic Structurel Indépendant

Lorsqu'une structure présente des symptômes préoccupants — une fissure qui s'agrandit, une poutre qui se déforme, la corrosion qui progresse — la première décision est la plus critique : qui doit diagnostiquer le problème ? S'adresser directement à une entreprise qui répare et exécute peut conduire à des solutions surdimensionnées ou qui ne traitent pas la cause réelle du problème.
...
N'ignorez pas les signaux que vous envoie votre bâtiment ou votre structure. Contactez-nous si vous observez :

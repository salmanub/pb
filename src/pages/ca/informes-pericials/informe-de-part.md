...
serviceProcess:
  ...
  - title: 'Suport i defensa'
    description: "Col·laborem amb el seu lletrat i defensem l'informe en el procediment"
...
# Client Testimonials
testimonials:
  - quote: "L'informe de part que van elaborar va ser la base de tota la nostra estratègia de negociació. Va ser tan clar i contundent que vam aconseguir un acord favorable sense necessitat d'anar a judici."
    author: "Despatx d'Advocats, Barcelona"
    role: 'Cas: Disputa per defectes constructius'
  - quote: "Vam presentar el seu informe al judici i va ser demolidor. La solvència de l'Albert durant la ratificació va ser clau perquè el jutge entengués la nostra postura. Un treball impecable."
    author: 'Client Particular'
    role: 'Cas: Reclamació per vicis ocults'

# CTA Section
ctaTitle: 'Necessita una prova tècnica per reforçar el seu cas?'
ctaDescription: "Un informe pericial de part és el seu millor argument. Contacti amb nosaltres i analitzarem la viabilitat de la seva reclamació."

# Introduction (shown in hero section)
intro: |
  <p>En qualsevol disputa o litigi, la part que presenta els arguments tècnics més sòlids té un avantatge decisiu. Un <strong>informe pericial de part</strong> és un dictamen encarregat per vostè per investigar la realitat tècnica dels fets i defensar la seva postura amb objectivitat i rigor.</p>

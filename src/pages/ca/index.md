...
servicios:
  ...
  description: "Oferim solucions tècniques i jurídiques precises, avalades per més de 15 anys d’experiència i una doble visió com a enginyer i perit d’assegurances."
  items:
    - title: "Peritatges de Construcció"
      description: "Analitzem en profunditat patologies, vicis ocults i defectes constructius."
      features:
        - "Anàlisi d’humitats i filtracions"
        - "Inspecció d’esquerdes estructurals"
        - "Informes per a comunitats"
      url: "/ca/peritatges-construccio/"
    - title: "Peritatges d’Assegurances"
      description: "Valorem danys, analitzem cobertures i fem contraperitatges."
      features:
        - "Valoració de danys per aigua i robatori"
        - "Contraperitatges i cobertures"
        - "Reclamacions a asseguradores"
      url: "/ca/peritatges-assegurances/"
...
ayuda:
  ...
  problemas:
    ...
    - title: "Despreniments i Danys per Mala Execució"
      ...
      icon: "alert-circle"
    - title: "Reforç Estructural amb Fibra de Carboni i Perfils Metàl·lics"

...
// .wrangler/tmp/pages-4BlWRX/functionsWorker-0.6875860995037612.mjs
...
var json = /* @__PURE__ */ __name2((s, b) => new Response(JSON.stringify(b), { status: s, headers: { "Content-Type": "application/json" } }), "json");
...
var json2 = /* @__PURE__ */ __name2((s, b) => new Response(JSON.stringify(b), { status: s, headers: CORS }), "json");
...
__name2(comparecenciaFlag, "comparecenciaFlag");
...
var onRequestOptions2 = /* @__PURE__ */ __name2(() => new Response(null, {
  status: 204,
  headers: {
    "Access-Control-Allow-Origin": "*",
    "Access-Control-Allow-Methods": "POST, OPTIONS",
...
var json3 = /* @__PURE__ */ __name2((s, b) => new Response(JSON.stringify(b), { status: s, headers: { "Content-Type": "application/json" } }), "json");
...
var NEVER = INVALID;
var textoObligatorio = /* @__PURE__ */ __name2((campo) => external_exports.string({ required_error: `falta ${campo}`, invalid_type_error: `${campo} debe ser texto` }).trim().min(1, `${campo} no puede estar vac\xEDo`), "textoObligatorio");
...
var mapaErroresEs = /* @__PURE__ */ __name2((issue, ctx) => {
  switch (issue.code) {
...
__name2(validarPeticion, "validarPeticion");
...
__name2(erroresLegibles, "erroresLegibles");
...
__name2(renderPdfPayload, "renderPdfPayload");
...
__name2(tokenValido, "tokenValido");
...
__name2(manejarPeticion, "manejarPeticion");
var onRequest = /* @__PURE__ */ __name2(async (context) => manejarPeticion(context.request, context.env), "onRequest");
...
// .wrangler/tmp/bundle-nJeKrT/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-nJeKrT/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6875860995037612.js.map

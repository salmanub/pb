...
// .wrangler/tmp/pages-UVFdS5/functionsWorker-0.5413842749279842.mjs
...
__name(forwardWithRetry, "forwardWithRetry");
__name2(forwardWithRetry, "forwardWithRetry");
...
async function onRequestPost(context) {
  ...
  try {
    ...
    const webhookUrl = perfil === "particular" ? env && env.MAKE_WEBHOOK_PARTICULAR : env && env.MAKE_WEBHOOK_PROFESIONAL;
    if (!webhookUrl) {
...
// .wrangler/tmp/bundle-c43Elt/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-c43Elt/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5413842749279842.js.map
